# -*- coding: utf-8 -*-
"""Classification_my_drive.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1d2TB_5c_sdhtpPgA4BOu7lO7tAAmPwxb
"""
...
basepath = "/content/drive/My Drive/Image Processing/IP/Dataset/Training set/"
...
img_path ='/content/drive/My Drive/Image/1.jpg'
feats = _get_features(img_path)
features['test'].append(feats.flatten())
testimgs.append(img_path)

preds = pipeline.predict(features['test'])

f, ax = plt.subplots(1, len(testimgs))
for i in range(len(testimgs)):
    ax[i].imshow(Image.open(testimgs[i]).resize((200, 200), Image.ANTIALIAS))
    ax[i].text(10, 180, '%s' % preds[i], color='k', backgroundcolor='red', alpha=0.8)
plt.show()

img_path ='/content/drive/My Drive/Image Processing/IP/Dataset/Test set/Or/O_17.jpg'
feats = _get_features(img_path)
go = []
...
# Read Image
import cv2
img = cv2.imread("/content/drive/My Drive/Image Processing/Mine/comp_1.jpeg")
